    ...
    <div class="py-10">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="backdrop-blur-xl bg-white/60 dark:bg-gray-800/50 shadow-xl border border-gray-200/40 
                ...
                <form action="{{ route('salles.update', $salle) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" name="localisation" id="localisation"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm 
                                      focus:border-blue-500 focus:ring focus:ring-blue-200 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 dark:focus:ring-blue-500"
                               value="{{ old('localisation', $salle->localisation) }}">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm 
                                         focus:border-blue-500 focus:ring focus:ring-blue-200 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 dark:focus:ring-blue-500">{{ old('description', $salle->description) }}</textarea>
                    ...
                    <div class="flex items-center space-x-2">
                        <input type="checkbox" name="disponibilite" id="disponibilite"
                               ...
                               @checked(old('disponibilite', $salle->disponibilite))>
